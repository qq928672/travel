...
<nav class="navbar navbar-expand-lg" style=background-color:#f4f4f4;>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="{{route('places1')}}">景點<i class="fas fa-map-marker-alt"></i>

        </a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="{{route('food1')}}">美食<i class="fas fa-utensils"></i>

        </a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="{{route('lodging1')}}">住宿<i class="fas fa-bed"></i>
